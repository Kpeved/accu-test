package com.lolkek.weather.features.details.view
...
class ForecastsRecyclerViewAdapter : RecyclerView.Adapter<ForecastsRecyclerViewAdapter.CustomViewHolder>() {
  ...
  private var items: List<ForecastUiModel> = emptyList()
  var callback: Callback? = null

  fun bindData(newItems: List<ForecastUiModel>) {
    val oldItems = items
